...
#text(style: "italic")[
  Отношение связности вершин в графе является отношением эквивалентности.

  Классы этого отношения называются *компонентами связности*.

  Граф с универсальными отношением связности называется *связным* (т.е. если любые две его вершины соединены цепью).
]

== Теорема (достаточное условие связности графа)
...
Итого $C^2_(n-1) > m$, что невозможно, так как $C^2_(n - 1) < m$ по условию $=>$ $H_0$ не может содержать больше одной или меньше $n - 1$ вершины. Но в обоих этих случаях максимальное возможное число ребер в $G$ получается равным $C^2_(n - 1)$, что так же противоречит неравенству из условия теоремы.
