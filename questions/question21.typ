...
Тогда производящая функция для последовательности ${a_n}$, $A(t)$ --- рациональна, т.е. $A(t) = (P(t))/(Q(t))$, где $P(t)$ и $Q(t)$ --- многочлены, степень $P(t)$ не более $k - 1$, а степень $Q(t)$ равна $k$.
...
Все следующие коэффициенты после $k$, равны $0$
...
Если производящая функция $A(t) = a_0 + a_1 t + dots$ --- рациональна, $A(t) = (P(t))/(Q(t))$, где $P(t) ~ Q(t)$ --- взаимно просты, то начиная с некоторого номера $n$ последовательность ${a_n}$ задается линейным однородным рекуррентным уравнением

$
a_(n + k) = c_1 a_(n + k - 1) + c_2 a_(n + k - 2) + dots + c_k a_n,
$

где $c_1, c_2, ..., c_k = "const"$, $k$ --- степень многочлена $Q(t)$.
