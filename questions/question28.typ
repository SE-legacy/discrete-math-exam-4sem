...
== Изоморфизм графов.
Два орграфа $arrow(G)_1 = (U_1, alpha_1)$ и $arrow(G)_2 = (U_2, alpha_2)$ называются изоморфными, если можно установить взаимно однозначное соответствие $phi: arrow(G)_1 -> arrow(G)_2$, сохраняющее отношение смежности:
