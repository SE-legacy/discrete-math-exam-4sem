...
/ Производящей функция: $a_0, a_1, a_2, dots, a_n, dots$ производящая последовательность чисел. Производящей функцие (ПФ) для этой последовательности
...
/ Суммой ПФ-ций: $A(t) = limits(sum)_(n = 0)^infinity a_n t^n$ и $B(t) = limits(sum)_(n = 0)^infinity b_n t^n$ 
