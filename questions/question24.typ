...
#let full_graphs = (
  FullGraph([K2], (0, 3), ((0, 0), (0, 2))),
  FullGraph([K3], (2, 3), ((2, 0), (2, 2), (3, 1))),
  FullGraph([K4], (5, 3), ((4, 0), (4, 2), (6, 0), (6, 2))),
)
...
== Дополнение графа
Пусть неориентированный граф $G = (V, alpha)$, тогда дополнение к $G$ называется $overline(G) = (V, overline(alpha) - Delta)$, где $overline(alpha)$ --- множество всех ребер, которые не содержатся в $alpha$, а $Delta$ --- множество всех рёбер, которые являются петлями.
...
Соединение сохраняет всё рёбра из $G_1$ и $G_2$, а также каждая вершина из $G_1$ соединена с каждой вершиной из $G_2$.
