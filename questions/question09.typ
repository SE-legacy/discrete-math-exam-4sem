...
$
  |A \\ limits(union.big)_(i = 1)^k A_i| = &C_(n_1 + k - 1)^(k - 1) dot C_(n_2 + k - 1)^(k - 1) dot dots dot C_(n_s + k - 1)^(k - 1) - \ &- space C^1_k dot C_(n_1 + k - 2)^(k - 2) dot dots dot C_(n_s + k - 2)^(k - 2) + dots + (-1)^(k - 1) dot C^(k - 1)_k - 1
$
