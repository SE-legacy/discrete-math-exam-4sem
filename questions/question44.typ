...
*Базой* орграфа называют подмножество вершин $V_0 subset.eq V$ такое, что любая вершина достижима из некоторой другой вершины из $V_0$, а любые две различные вершины из $V_0$ взаимно недостижимы.
