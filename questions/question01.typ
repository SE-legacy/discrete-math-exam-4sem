...
/ Размещения без повторений из $n$ различных элементов по $k$ элементов: называют все различные комбинации из $k$ элементов, выбранных из $n$ исходных элементов, которые отличаются друг от друга порядком следования элементов
