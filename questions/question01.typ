...
/ Размещения с повторениями из $n$ типов по $k$ элементов: называются все такие комбинации из $k$ элементов, выбранных из $n$ исходных типов, которые отличаются друг от друга порядком следования или составом элементов.
...
/ Размещения без повторений из $n$ различных элементов по $k$ элементов: называют все различные комбинации из $k$ элементов, выбранных из $n$ исходных элементов, которые отличаются друг от друга порядком следования или составом элементов.
