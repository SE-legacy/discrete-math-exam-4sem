...
$ cases(reverse: #true, r_1 - "решение" arrow.r.double space r_1^n - "решение" arrow.r.double space alpha r_1^n - "решение",
...
Подставим в формулу рекуррентного соотношения полученные коэфициенты:
...
Осталось показать, что $n r^n$ --- решение. Подставим его в формулу рекуррентного соотношения с найденными коэфициентами:

$ (n + 2) r^(n + 2) = 2 r (n + 1) r^(n + 1) - r^2 n r^n => \ (n + 2) r^(n + 2) = (n + 2) r^(n + 2) $

Так как при подстановке $n r^n$ в формулу рекуррентного соотношения получилось тождество, то $n r^n$ --- его решение. Следовательно, $beta n r^n$ --- тоже решение.
