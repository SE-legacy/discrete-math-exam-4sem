...
Граф планарен $<=>$ в нем нет частей, изоморфных графам типа I или типа II.

*Доказательство*: (докажем только необходимость, достаточность не надо)

Пусть у нас $G$ --- планарный граф.

Докажем от противного. Мы предполагаем, что граф планарен и в нем есть части, изоморфные графам типа I или II $=> K_(3, 3)$ --- планарный, $K_5$ --- планарный

Рассмотрим граф $K_5$ в нем $n = 5, space m = 10$.

Воспользуемся необходимым условием планарности (Следствие 3)
